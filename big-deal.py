...
#
# больше подойдет структура данных "словарь": уникальный "ключ" - четырехзначный ext из users.conf
# ему сопоставляется значение "name" из того же файла и внешние телефонные номера из
# extensions.conf DID1, DID2, DID3 ...
#
